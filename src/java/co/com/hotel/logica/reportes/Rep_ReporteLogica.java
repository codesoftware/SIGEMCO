...
public class Rep_ReporteLogica {
    ...
    public String generarReporteConteoXLs(String copr_copr, String ruta, String rutaDestino) {
        String rta = "Ok";
        Connection conn = null;
        try {
            conn = this.generarConexion();
    ...
    /**
     * Funcion con la cual se genera el excel para los reportes basicos
     *
     * @param ruta
     * @param rutaDestino
     * @return
     */
    public String generaReporteBasico(String ruta, String rutaDestino) {
        String rta = "Ok";
        Connection conn = null;
        try {
            conn = this.generarConexion();
